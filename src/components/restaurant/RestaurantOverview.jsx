...
const { FiDollarSign, FiShoppingBag, FiClock, FiStar, FiTrendingUp } = FiIcons;
...
const RestaurantOverview = () => {
  ...
  const stats = [
    {
      label: 'Ingresos Hoy',
      value: `$${todayOrders.reduce((sum, order) => sum + order.total, 0).toFixed(2)}`,
      icon: FiDollarSign,
      color: 'bg-green-500',
      change: '+15.3%'
    },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="space-y-3">
            <button className="w-full bg-primary-500 text-white p-3 rounded-lg hover:bg-primary-600 transition-colors">
